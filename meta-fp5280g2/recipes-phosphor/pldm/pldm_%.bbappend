...
SRC_URI += "file://integer_attrs.json"
SRC_URI += "file://string_attrs.json"
...
do_install_append() {
        ...
        install -m 0644 ${WORKDIR}/integer_attrs.json ${D}${datadir}/pldm/bios/
        install -m 0644 ${WORKDIR}/string_attrs.json ${D}${datadir}/pldm/bios/
