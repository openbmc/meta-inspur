...
PV = "1.0+git${SRCPV}"
SRCREV = "fb0ac692949d5c6f2b35bbec6ec9289080909fb2"
...
INSPUR_PSU_MONITOR_FMT = "${systemd_system_unitdir}/${INSPUR_PSU_MONITOR_TMPL}:${INSPUR_PSU_MONITOR_TGT}.requires/${INSPUR_PSU_MONITOR_INSTFMT}"
